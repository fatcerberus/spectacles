...
Game.scenes =
{
	opening: function() {
		new scenes.Scene()
			...
			.pause(1.0)
			.talk("Bruce", false, 0.5, 2.0, "He was.")
			.pause(2.0)
			.talk("Bruce", false, 0.5, 2.0, "Honestly, though?  The one thing that amazes me, even now...")
			.pause(1.0)
			.adjustBGM(0.0, 5.0)
			.pause(1.0)
			...
			.talk("Amanda", true, 1.0, Infinity, "Circumstances beyond my control long ago forced my hand. Frankly, I don't see that I have any other choice. At times I wonder if I ever did...")
			.talk("Robert", true, 1.0, Infinity, "I get it, I really do. It's just... well, I just wish you didn't have to leave Lucida to do it.")
			.pause(1.0)  // TODO: Amanda faces house
			.talk("Amanda", true, 1.0, Infinity,
			...
			.talk("Amanda", true, 1.0, Infinity, "Lucida would be destroyed.")
			.pause(0.5)  // TODO: Robert steps away from burning house
			.talk("Robert", true, 1.0, Infinity, "So this is it? You're just going to walk out on all of us?")
			.talk("Amanda", true, 1.0, Infinity, "Remember something for me, Robert. Not once have I ever left you to fend for yourself. No matter what's happened, I've always come back. Always.")
			.talk("Robert", true, 1.0, Infinity, "Maybe it's nothing. I don't know. But I can't help thinking I'll never see you again. I'm worried, Amanda. More worried than I've ever been about anything. What if something happens? What if you don't return?")
			.talk("Amanda", true, 1.0, Infinity, "I'll come back, Robert. I promise.")
			.fork()
				.pause(0.5)
