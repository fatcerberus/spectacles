...
function game()
{
	...
	var setup = {
		...
		party: {
			...
			elysia: { level: 60, weapon: 'fireAndIce', items: [ 'tonic', 'powerTonic', 'redBull', 'holyWater', 'vaccine', 'lazarusPotion' ] },
			justin: { level: 60, items: [ 'tonic', 'powerTonic', 'redBull', 'holyWater', 'vaccine', 'lazarusPotion' ] },
