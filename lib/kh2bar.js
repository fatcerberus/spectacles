/**
 *  kh2bar CommonJS module for Sphere v2
...
//     color:      The color of the gauge.  (default: Color.Chartreuse)
...
function HPGauge(capacity, sectorSize, color, maxSectors)
{
	if (arguments.length < 1)
		throw new RangeError("requires at least 1 argument");

	sectorSize = sectorSize !== undefined ? sectorSize : 100;
	color = color !== undefined ? color.clone() : Color.Chartreuse;
...
HPGauge.prototype.draw = function(x, y, width, height)
{
	if (arguments.length < 4)
		throw new RangeError("requires 4 arguments");
...
{
	if (arguments.length < 1)
		throw new RangeError("requires 1 argument");
...
{
	this.colorFadeTimer += 1.0 / screen.frameRate;
